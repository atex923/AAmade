...
QTY_EXPR_INDEX = 5
QTY_RESULT_INDEX = 6
QTY_SYNC_COLUMNS = (0, 1, 2, 3, 4, 6)
QTY_EDITABLE_COLUMNS = (2, 3, 4, 5)
QTY_OPERATORS = {
...
class BudgetEditor(tk.Tk):
    ...
    def calculate_quantity_page(self):
        ...
        for row_index, row in enumerate(self.quantity_data):
            ...
            if row_index < len(self.rows_data):
                self.rows_data[row_index][QTY_RESULT_INDEX] = result
            if row_index < len(self.cell_vars):
                target_var = self.cell_vars[row_index][QTY_RESULT_INDEX]
